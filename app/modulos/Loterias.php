...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO loterias (codigo, nombre, usuario) VALUES (%s, %s, %s)",
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE loterias SET codigo=%s, nombre=%s WHERE id=%s",
                       GetSQLValueString($_POST['codigo'], "text"),
                       GetSQLValueString($_POST['nombre'], "text"),
...
mysql_select_db($database_gchance, $gchance);
$query_listado = "SELECT a.*,acc.usuario usu FROM loterias a,acceso acc WHERE a.usuario=acc.id  ORDER BY a.id DESC";
...
mysql_select_db($database_gchance, $gchance);
$query_usu = sprintf("SELECT * FROM loterias WHERE id = %s", GetSQLValueString($colname_usu, "int"));
