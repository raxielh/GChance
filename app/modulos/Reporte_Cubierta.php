...
<div class="tab-content ">
    ...
    <form action="index.php?modulo=Reporte_Cubierta" method="get" >
    
    
    <table width="100%" border="0">
  <tr>
    <td width="20%"><input type="date" name="fecha" value="<?php echo date('Y-m-d'); ?>" class="form-control" size="20" required /><input type="hidden" name="modulo" value="Reporte_Cubierta" class="form-control" size="20" /></td>
      ...
      <table width="100%" border="1" id="Exportar_a_Excel">
		...
		do { ?>
          ...
          <td align="center"><?php echo $row_listado['fecha']; ?></td>
            <?php  $av=$row_listado['agencia_valor']; ?></td>
