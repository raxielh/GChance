...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $valor=str_replace(".", "",$_POST['valor']);
     $insertSQL = sprintf("INSERT INTO tope (fecha, tope,usuario) VALUES (%s,%s,%s)",
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
	$valor=str_replace(".", "",$_POST['valor']);
  $updateSQL = sprintf("UPDATE tope SET fecha=%s, tope=%s WHERE id=%s",
...
mysql_select_db($database_gchance, $gchance);
$query_listado = "SELECT a.*,acc.usuario usu FROM tope a,acceso acc WHERE a.usuario=acc.id  ORDER BY a.id DESC";
...
mysql_select_db($database_gchance, $gchance);
$query_usu = sprintf("SELECT * FROM tope WHERE id = %s", GetSQLValueString($colname_usu, "int"));
    ...
    <tbody>
      <?php do { ?>
        <tr>
          ...
          <td><?php echo number_format($row_listado['tope']); ?></td>
          ...
          <div class="col-md-3">
              <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
                <table align="center">
                  ...
                  <tr valign="baseline">
                    <td nowrap="nowrap" align="right">Tope:</td>
                    <td><input type="text" name="valor" onkeyup="puntitos(this,this.value.charAt(this.value.length-1))" required value="<?php echo htmlentities($row_usu['tope'], ENT_COMPAT, ''); ?>" size="32" /></td>
                  </tr>
                  <tr valign="baseline">
	...
	<div class="tab-pane" id="2">
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
          <table align="center">
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Fecha:</td>
              <td><input type="date" name="fecha" value="<?php echo date('Y-m-d') ?>" class="form-control" size="32" required /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Tope:</td>
              <td><input type="text" name="valor" value="" size="32"  onkeyup="puntitos(this,this.value.charAt(this.value.length-1))"  required /></td>
            </tr>
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">&nbsp;</td>
